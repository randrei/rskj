...
public class BridgeSupport {
    ...
    public static final Integer RECEIVE_HEADER_LAST_TIMESTAMP_TOO_SHORT = -1;
    ...
    public Integer receiveHeader(BtcBlock header) throws IOException, BlockStoreException {
        ...
        long diffTimeStamp = bridgeConstants.getTimeReceiveHeadersBetweenCalls();
        ...
        if (optionalLastTimeStamp.isPresent() && (currentTimeStamp - optionalLastTimeStamp.get().longValue() < diffTimeStamp)) {
            ...
            return RECEIVE_HEADER_LAST_TIMESTAMP_TOO_SHORT;
        }
